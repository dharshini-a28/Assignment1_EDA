...
📌 About the Project
This project analyzes a Superstore sales dataset using Python. The main goal is to understand the sales performance of different product categories and explore important business information such as Sales, Quantity, Discount, Profit, and Delivery Days.
